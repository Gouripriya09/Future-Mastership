    ...
    <div className="CourseDetail light">
      ...
      >
        ...
        <div className="right-course">
          <div className="course-box">
            <div className="cb-1">
              <p className="course-box-head">AI Course</p>
              <p className="course-box-desc">
                Master the foundations of Artificial Intelligence with our AI
                course. This course provides a deep dive into the dynamic field
                of AI, covering everything from fundamental concepts to
      ...
      >
        ...
        <div id="about-c">
          <h1>Overview</h1>
          <p>
          Master the foundations of Artificial Intelligence with our AI course. This course provides a deep dive into the dynamic field of AI, covering everything from fundamental concepts to practical applications.
