  ...
  return (
    <div className="refund">
      ...
      <div className="refund-policy">
        <h2 className="col-class f-ss rf">Refund Policy</h2>
        <div className="scroll-container">
          Last Revised: December 16, 2013 <br /> Welcome to
          ...
          <br />
          1. YOUR AGREEMENT
          <br /> By using this Site, you agree to be bound by, and to comply
          with, these Terms and Conditions. If you do not agree to these Terms
          ...
          contained on such Linked Sites.
          <br />
          You will need to make your own independent judgment regarding your
          interaction with these Linked Sites. <br />
          4. FORWARD LOOKING STATEMENTS
          <br /> All materials reproduced on this site speak as of the original
          date of publication or filing. The fact that a document is available
          on this site does not mean that the information contained in such
          document has not been modified or superseded by events or by a
          subsequent document or filing.
          <br /> We have no duty or policy to update any information or
          ...
          <br /> (ii) THE SITE IS PROVIDED ON AN "AS IS" AND "AS AVAILABLE"
          BASIS;
          <br /> (iii) EXCEPT AS EXPRESSLY PROVIDED HEREIN WE DISCLAIM ALL
          ...
          <br /> (v) ANY MATERIAL DOWNLOADED OR OTHERWISE OBTAINED THROUGH THE
          USE OF THE SITE IS DONE AT YOUR OWN DISCRETION AND RISK; and <br />
          ...
          SUCH MATERIAL.
          <br /> B. YOU UNDERSTAND AND AGREE THAT UNDER NO CIRCUMSTANCES,
          ...
          <br /> 6. EXCLUSIONS AND LIMITATIONS <br />
          ...
          <br /> 7. OUR PROPRIETARY RIGHTS <br />
          ...
          <br /> You agree not to: (a) modify, alter, or deface any of the
          trademarks, service marks, trade dress (collectively "Trademarks") or
          other intellectual property made available by us in connection with
          the Site; (b) hold yourself out as in any way sponsored by, affiliated
          with, or endorsed by us, or any of our affiliates or service
          providers; (c) use any of the Trademarks or other content accessible
          through the Site for any purpose other than the purpose for which we
          have made it available to you; (d) defame or disparage us, our
          Trademarks, or any aspect of the Site; and (e) adapt, translate,
          modify, decompile, disassemble, or reverse engineer the Site or any
          software or programs used in connection with it or its products and
          services. The framing, mirroring, scraping or data mining of the Site
          or any of its content in any form and by any method is expressly
          prohibited. <br />
          8. INDEMNITY
          <br /> By using the Site web sites you agree to indemnify us and
          ...
          sites, your use of the Products and Services, or your submission of
          ideas and/or related materials to us or from any person's use of any
          ID, membership or password you maintain with any portion of the Site,
          regardless of whether such use is authorized by you.
          <br /> 9. COPYRIGHT AND TRADEMARK NOTICE <br />
          ...
          <br /> 10. INTELLECTUAL PROPERTY INFRINGEMENT CLAIMS
          <br /> It is our policy to respond expeditiously to claims of
          ...
          should be directed to: generator.lorem-ipsum.info
          <br /> 126 Electricov St. Kiev, Kiev 04176 <br />
          Ukraine <br />
          ...
          purchase orders.
          <br /> B. No Joint Venture, No Derogation of Rights. You agree that no
