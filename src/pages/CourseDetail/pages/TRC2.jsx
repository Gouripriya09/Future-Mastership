  ...
  const handleEnroll = async () => {
    try {
      ...
      if (userDocSnapshot.exists()) {
        ...
        // Check if "TRC2" is already in the courses array
        if (!coursesArray.includes("TRC2")) {
          coursesArray.push("TRC2");

          // Update the user document with the updated courses array
          await updateDoc(userDocRef, { courses: coursesArray });

          console.log("Enrolled in TRC2 successfully!");
          navigate("/dashboard");
        } else {
          console.log("Already enrolled in TRC2.");
        }
      }
    } catch (error) {
      console.error("Error enrolling in TRC2:", error.message);
    }
  };
      ...
      >
        <div className="left-course">
          ...
          <div className="fot">
            ...
            <button onClick={handleEnroll} className="enroll">Enroll</button>
